import torch
import ray
from dual_stage_model import LocalController
from local_controller_woker import LocalControllerWorker
...
class Runner(object):
    def __init__(self, meta_agent_id):
        ...
        self.local_network = LocalController()
    ...
    def do_job(self, episode_number):
        ...
        # save_img = True
        worker = LocalControllerWorker(self.meta_agent_id, episode_number, device=self.device, save_image=save_img)
        worker.run_episode()
